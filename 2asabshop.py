...
def root(): 
	...
	# Add image file
	bg2= PhotoImage( file = "medium1.png")
	...
	# Add text
	label2 = Label( root, text = "Welcome To Hussein 2asab Shop", bg = "#88cffa")
...
window.title('Hussein 2asab Shop')
label.place(x = 0, y = 0)
label_1 = Label(window , text = "Welcome To Our Shop", fg = 'green',bg = 'yellow', font =('Georgia', 24))
label_1.pack(side = TOP)
B1=Button(window , text = "Taking Orders" ,background="yellow3", font =('Georgia', 14) , fg="green" , bd = '0',command= root ,width='12',height='1')
